...
public class HtreeHTreeSedgewick {
    ...
    public static void drawH(double x, double y, double size) {
        ...
        //StdDraw.line(x0, y0, x1, y0);    // right vertical segment of the H
        //StdDraw.line(x0,  y0, x1,  y1);    // connect the two vertical segments of the H
        
        //StdDraw.line(x0, y0, x0, y1); // H
        ...
        //StdDraw.line(x0, y0, x1, y0);    // right vertical segment of the H
     	...
     	StdDraw.line(x1, y0, x1, y1);    // left  vertical segment of the H
        StdDraw.line(x0, y1, x1, y1);    // right vertical segment of the H
     	StdDraw.line(x0,  y1, x1,  y0);    // connect the two vertical segments of the H
    }
